...
public class ConfigBean {
    ...
    public void populateDB() {
        try {
            profissionalSaudeBean.create( "Ana", "ana@mail.pt", "1234");
            //profissionalSaudeBean.create("Ana2", "ana2@mail.pt", "1234");
            doenteBean.create("João", "joao@mail.pt", "1234", "912345678", "Rua da Cova nº140", "ana@mail.pt");
            //doenteBean.create("João2", "joao2@mail.pt", "1234", "9123456782", "Rua da Cova2 nº1402", "ana@mail.pt");
            //doenteBean.create("João3", "joao3@mail.pt", "1234", "9123456783", "Rua da Cova3 nº1403", "ana2@mail.pt");
            adminBean.create("Pedro", "pedro@mail.pt", "1234");
